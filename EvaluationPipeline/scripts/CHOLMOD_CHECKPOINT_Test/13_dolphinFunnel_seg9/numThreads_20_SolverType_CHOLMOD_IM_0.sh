...
export Config=/mnt/IPC-dev2/input/seg/13_dolphinFunnel_seg9.txt
export progMode=100


singularity exec $SING_SIF bash -c "$PROG_PATH $progMode $Config --SimName=../../csv/13_dolphinFunnel_seg9_numThreads_20_SolverType_CHOLMOD_IM_0 --output=/mnt/CHOLMOD_CHECKPOINT_Test/13_dolphinFunnel_seg9/numThreads_20_SolverType_CHOLMOD_IM_0 --DoAnalysis=0 --SolverType=CHOLMOD --numThreads=20 --IM=0"
