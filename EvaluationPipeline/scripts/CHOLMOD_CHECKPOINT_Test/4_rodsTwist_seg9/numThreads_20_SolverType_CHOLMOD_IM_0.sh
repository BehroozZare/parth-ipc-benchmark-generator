...
singularity exec $SING_SIF bash -c "$PROG_PATH $progMode $Config --SimName=../../csv/4_rodsTwist_seg9_numThreads_20_SolverType_CHOLMOD_IM_0 --output=/mnt/EvaluationPipeline/scripts/CHOLMOD_CHECKPOINT_Test/4_rodsTwist_seg9/numThreads_20_SolverType_CHOLMOD_IM_0 --DoAnalysis=0 --SolverType=CHOLMOD --numThreads=20 --IM=0"
