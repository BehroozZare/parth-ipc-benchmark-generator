...
export Config=/mnt/input/seg/1_squeezeOut_seg4.txt
export progMode=100


singularity exec $SING_SIF bash -c "$PROG_PATH $progMode $Config --SimName=../../csv/1_squeezeOut_seg4_numThreads_20_SolverType_CHOLMOD_IM_0 --output=/mnt/EvaluationPipeline/scripts/CHOLMOD_CHECKPOINT_Test/1_squeezeOut_seg4/numThreads_20_SolverType_CHOLMOD_IM_0 --DoAnalysis=0 --SolverType=CHOLMOD --numThreads=20 --IM=0"
