...
template <typename vectorTypeI, typename vectorTypeS>
void EigenLibSolver<vectorTypeI, vectorTypeS>::innerAnalyze_pattern(void) {
  simplicialLDLT.analyzePattern(coefMtr);
  assert(simplicialLDLT.info() == Eigen::Success);
}

template <typename vectorTypeI, typename vectorTypeS>
bool EigenLibSolver<vectorTypeI, vectorTypeS>::innerFactorize(void) {
  std::cout << "======================================= EIGEN is being used "
               "=================================="
            << std::endl;
...
template <typename vectorTypeI, typename vectorTypeS>
void EigenLibSolver<vectorTypeI, vectorTypeS>::innerSolve(
